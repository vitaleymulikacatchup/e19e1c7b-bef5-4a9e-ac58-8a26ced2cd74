...
export default function App() {
  ...
  <div id="hero" data-section="hero">
      ...
      imageAlt="happy rescued puppy portrait"
    />
  </div>
      ...
      items={[
        {
          ...
          description: "Professional veterinary and behavioral support.",
        },
        {
          icon: Home,
          title: "Safe Haven",
          description: "A comfortable, stress-free environment.",
        },
        {
          icon: Users,
          title: "Community Focus",
          description: "Connecting animals with loving local families.",
        },
      ]}
      imageSrc="https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=qmov8p"
      imageAlt="modern animal shelter interior"
    />
  </div>
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        {
          value: "1,200+",
          description: "Animals rescued per year",
        },
        {
          value: "95%",
          description: "Successful adoption rate",
        },
        {
          value: "500+",
          description: "Active local volunteers",
        },
      ]}
    />
  </div>
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          title: "Perfect Match",
          quote: "Our puppy brought so much energy to our home. The shelter process was so smooth!",
          name: "Sarah J.",
          role: "Adoptive Parent",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=sg8ivv",
        },
        {
          title: "Lifesaver",
          quote: "We weren't sure about adopting, but the team here made us feel so confident and supported.",
          name: "Mark D.",
          role: "Pet Owner",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=9ral2a",
        },
        {
          title: "So Grateful",
          quote: "My cat is the sweetest companion. The support after adoption was unexpected and helpful.",
          name: "Elena R.",
          role: "Adopter",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=xz2rh2",
        },
        {
          title: "Wonderful Experience",
          quote: "Great communication and genuinely caring staff. Could not ask for better support.",
          name: "David K.",
          role: "Pet Owner",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=sy16a1",
        },
        {
          title: "Highly Recommend",
          quote: "Adopting here was the best decision we made all year. Simply life-changing.",
          name: "Lisa B.",
          role: "Volunteer & Adopter",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=ar9s77",
        },
      ]}
    />
  </div>
      ...
      items={[
        {
          ...
          answer: "You can start by browsing our available animals online or visiting us in person during open hours.",
        },
        {
          question: "Are all animals vaccinated?",
          answer: "Yes, every animal is fully vetted and vaccinated prior to adoption.",
        },
        {
          question: "Can I return a pet if it's not a match?",
          answer: "We encourage a trial period, and our team is always available to help solve adjustment issues.",
        },
      ]}
      imageSrc="https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=tmvqjj"
      imageAlt="cute kitten playing"
    />
  </div>
  ...
  <div id="contact" data-section="contact">
      ...
      imageAlt="happy person petting dog"
    />
  </div>
